...
set trust31 [expr ($node31+$node_31)*$bw31]
   ...
   puts " Energy Valuation of nodes in cluster_1 determined as"
   puts " Energy Valuation of node 0: $node0 joules "
   puts " Energy Valuation of node 1: $node1 joules "
   puts " Energy Valuation of node 2: $node2 joules "
   puts " Energy Valuation of node 3: $node3 joules "
   puts " Energy Valuation of node 4: $node4 joules "
   #puts " Energy Valuation of node 5: $node5 joules "
   puts " Energy Valuation of node 6: $node6 joules "
   #puts " Energy Valuation of node 7: $node7 joules "
   #puts " Energy Valuation of node 8: $node8 joules "
   puts " Energy Valuation of node 9: $node9 joules "

   puts " Energy Valuation Reward of nodes in cluster_1 determined as"
   puts " Energy Valuation after resources recived of node 0: $node_0 joules "
   puts " Energy Valuation after reward of node 1: $node_1 joules "
   puts " Energy Valuation after reward of node 2: $node_2 joules "
   puts " Energy Valuation after reward of node 3: $node_3 joules "
   puts " Energy Valuation after resources recivedof node 4: $node_4 joules "
   #puts " Energy Valuation after resources recived node 5: $node5 joules "
   puts " Energy Valuation after resources recived of node 6: $node_6 joules "
   #puts " Energy Valuation after reward of node 7: $node7 joules "
   #puts " Energy Valuation after reward 8: $node8 joules "
   puts " Energy Valuation after reward of node 9: $node_9 joules "

   puts " single-Task Packet delivery of node 0: $trust0 "
   puts " single-Task Packet delivery of node 1: $trust1 "
   puts " single-Task Packet delivery of node 2: $trust2 "
   puts " single-Task Packet delivery of node 3: $trust3 "
   puts " single-Task Packet delivery of node 4: $trust4 "
   puts " single-Task Packet delivery of node 6: $trust6 "
   puts " single-Task Packet delivery of node 9: $trust9 "


   puts " *************************************************"
   
   puts " Energy Valuation of nodes in cluster_2 determined as"
   puts " Energy Valuation of node 11: $node11 joules "
   #puts " Energy Valuation of node 12: $node12 joules "
   #puts " Energy Valuation of node 13: $node13 joules "
   puts " Energy Valuation of node 14: $node14 joules "
   #puts " Energy Valuation of node 15: $node15 joules "
   puts " Energy Valuation of node 16: $node16 joules "
   puts " Energy Valuation of node 17: $node17 joules "
   puts " Energy Valuation of node 18: $node18 joules "
   #puts " Energy Valuation of node 19: $node19 joules "
   puts " Energy Valuation of node 29: $node29 joules "
   puts " Energy Valuation of node 30: $rmr1 joules "
   
   puts " Energy Valuation Reward of nodes in cluster_2 determined as"
   puts " Energy Valuation after reward received of node 11: $node_11 joules "
   puts " Energy Valuation after reward received of node 12: $node_12 joules "
  # puts " Energy Valuation after resource received of node 13: $node_13 joules "
   puts " Energy Valuation after resources received of node 14: $node_14 joules "
  # puts " Energy Valuation after reward received of node 15: $node_15 joules "
   puts " Energy Valuation after reward received of node 16: $node_16 joules "
   puts " Energy Valuation after resources received of node 17: $node_17 joules "
   puts " Energy Energy Valuation after reward received of node 18: $node_18 joules "
   #puts " Energy Valuation after reward received of node 19: $node_19 joules "
   puts " Energy Valuation after reward received of node 29: $node_29 joules "
   puts " Energy Valuation after reward received of node 30: $rmr_1 joules "
...
puts " *************************************************"
   ...
   puts " List of packets received on each node of multiple tasks"
    puts " Trust value of node 11: $trust11 "
 puts " Packet Received of node 12: $trust12 "
 puts " Packet Received of node 14: $trust14 "
 puts " Packet Received of node 16: $trust16 "
 puts " Packet Received of node 17: $trust17 "
 puts " Packet Received of node 18: $trust18 "
 puts " Packet Received of node 29: $trust29 "
 puts " Packet Received of node 30: $trust30 "

   puts " *************************************************"
   
   puts " Energy Valuation of nodes in cluster_3 determined as"
   puts " Energy Valuation of node 20: $node20 joules "
   #puts " Energy of node 21: 40 joules "
   #puts " Energy Valuation of node 22: $node22 joules "
   #puts " Energy Valuation of node 23: $node23 joules "
   puts " Energy Valuation of node 24: $node24 joules "
   puts " Energy Valuation of node 25: $node25 joules "
   puts " Energy Valuation of node 26: $node26 joules "
   puts " Energy Valuation of node 27: $node27 joules "
   puts " Energy Valuation of node 28: $node28 joules "
   puts " Energy Valuation of node 31: $node31 joules "
   puts " Energy Valuation of node 32: $rmr2 joules "

   puts " Energy Valuation rewards of nodes in cluster_3 determined as"
   puts " Energy Valuation after resource received of node 20: $node_20 joules "
   puts " Energy Valuation after resource received of node 24: $node_24 joules "
   puts " Energy Valuation after reward received of node 25: $node_25 joules "
   puts " Energy Valuation after resource received of node 26: $node_26 joules "
   puts " Energy Valuation after reward received of node 27: $node_27 joules "
   puts " Energy Valuation after resource received of node 28: $node_28 joules "
   puts " Energy Valuation after reward received of node 31: $node_31 joules "
   
   puts " *************************************************" 
   puts " EFFICIENCY TABLE INFORMATION OF NODES "
   puts " *************************************************"
...
set angle [expr "((($y2+$y1)/($x2+$x1))*360)/3.14"]
}
}
...
set angle1 [expr "((($y2+$y1)/($x2+$x1))*360)/3.14"]
}
}
...
set angl2 [expr "((($y2+$y1)/($x2+$x1))*360)/3.14"]
}
}
set trust29 19
set trust1 4864
...
$ns at 1.01 "$ns trace-annotate \" cluster_head  node id_1first cluster distance and direction range $angle \""
$ns at 1.03 "$ns trace-annotate \" cluster_head  node id_11second cluster distance and direction range $angle1 \""
$ns at 1.06 "$ns trace-annotate \" cluster_head  node id_20third cluster distance and direction range $angle \""
